...
def isSystemDLL(pathname):
    ...
    if os.path.basename(pathname).lower() in ("libfreetype-6.dll", "libogg-0.dll","sdl_ttf.dll","libogg.dll","libvorbis.dll","libvorbisfile.dll"): # "sdl_ttf.dll" added by arit.
            return 0
...
class BuildExe:
    def __init__(self):
        #Name of starting .py
        self.script = "flappybird.py"
 
        #Name of program
        self.project_name = "Flappy Bird"
 
        #Project url
        self.project_url = "https://github.com/cs-cordero/Flappy-Bird"
        ...
        self.copyright = "Copyright (c) 2016 Christopher Cordero"
 
        #Description
        self.project_description = "The popular mobile game recreated in Python."
 
        #Icon file (None will use pygame default icon)
        self.icon_file = None
 
        #Extra files/dirs copied to game
        self.extra_datas = ['scripts','fonts','audio','images']
